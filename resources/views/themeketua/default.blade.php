...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/myHome') }}">
            ...
            <!-- Nav Item - Kas -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('santri.laporan') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('laporan.infaq') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('kas.laporan') }}">
